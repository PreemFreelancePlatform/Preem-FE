...
export const Setup = (props) => {
  ...
  const handleSubmit = async () => {
    ...
    await axiosWithAuth()
      .patch(
        `http://localhost:2019/freelancer/upload/${props.data.freelancerid}`,
        fd
      )
      .then((res) => {
        return axiosWithAuth()
          .patch(
            `http://localhost:2019/freelancer/freelancer/${props.data.freelancerid}`,
            security
          )
          .then((res) => {
            setTimeout(function () {
  ...
  return (
    <div className="setup-cont">
      ...
      {anim1 && (
        <span className="welcomeanim">Lets set up a few more things</span>
      )}
      {content && (
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="sec-form">
      <div className="infos">
        ...
        <p>
          please choose and answer each question carefully, they will be used in
          the event of a lost password. Answers ARE case sensitive.
        </p>
      </div>
      ...
      <div className="formys">
        ...
        >
          ...
          <option value="What was your childhood phone number?">
        ...
        <select
          ...
          ref={register({ required: true })}
        >
          <option value="What was the name of your first dog?">
          ...
          <option value="Where does your nearest sibling live?">
